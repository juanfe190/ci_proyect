      ...
      <div class="portlet light">
        <div class="portlet-title">
          <div class="caption">
            ...
            <span class="caption-subject font-blue-sharp bold uppercase">{{$curso->name}} &ndash; Editar Etapa: {{$etapa->name}}</span>
          </div>
        </div>
        <div class="portlet-body form">
          {!! Form::model($etapa, ['route' => ['stages.update', $curso->url, $etapa->id], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
            @include('pages.etapas.form', ['submitButtonText'=>'Actualizar Etapa'])
          {!! Form::close() !!}
        </div>
      </div>
    </div>
