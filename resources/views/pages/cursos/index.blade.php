      ...
      <div class="portlet light">
        <div class="portlet-title">
          <div class="caption font-dark">
            ...
            <span class="caption-subject bold uppercase">Cursos</span>
          </div>
          <div class="actions">
            <div class="btn-group btn-group-devided">
                <a href="{{ route('courses.create') }}" class="btn btn-circle red btn-outline"><i class="fa fa-plus"></i> Curso Nuevo</a>
            </div>
            <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-right" id="courses_index_tools">
                    <li>
        ...
        <div class="portlet-body">
          <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="courses_index_table">
            <thead>
              <th class="all">Id</th>
              <th class="all">Nombre</th>
              <th class="all">Categor&iacute;a</th>
              <th class="all">C&oacute;digo de Video</th>
            ...
            <tbody>
              ...
              @foreach($cursos as $curso)
                <tr>
                  ...
                  <td>{{$curso->video_code}}</td>
                  <td>
                    <a href="{{route('stages.index', ['name'=>$curso->url])}}" class="btn btn-sm green">Ver Etapas</a>
                    <a href="{{route('courses.edit', ['name'=>$curso->url])}}" class="btn btn-sm blue">Editar</a>
                    {{Form::open(array('route' => array('courses.destroy', $curso->id), 'method' => 'delete', 'class' => 'deleteForm'))}}
