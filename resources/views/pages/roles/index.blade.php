      ...
      <div class="portlet light">
        <div class="portlet-title">
          <div class="caption font-dark">
            ...
            <span class="caption-subject bold uppercase">Roles de Usuario</span>
          </div>
          <div class="actions">
            <div class="btn-group btn-group-devided">
                <a href="{{ route('roles.create') }}" class="btn btn-circle red btn-outline"><i class="fa fa-plus"></i> Rol Nuevo</a>
            </div>
            <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-right" id="roles_index_tools">
                    <li>
        ...
        <div class="portlet-body">
          <table class="table table-striped table-bordered table-hover" id="roles_index_table">
            <thead>
              <th>Nombre de Rol</th>
              <th>Opciones</th>
            </thead>
            ...
            <tbody>
              @foreach($rols as $rol)
               <tr>
                <td>{{$rol->rol_name}}</td>
                <td>
                  <a href="{{route('roles.edit', ['name'=>strtolower($rol->rol_name)])}}" class="btn btn-sm blue">Editar</a>

                  {{Form::open(array('route' => array('roles.destroy', $rol->id), 'method' => 'delete', 'class' => 'deleteForm'))}}
